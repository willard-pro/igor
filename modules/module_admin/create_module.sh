...
function create_module() {
	...
	local env_file="config/env_dev.json"
	...
	log IGOR "Module ${BOLD}$module_label${RESET} has been created and is ready for development.  Remember to start Igor in ${BOLD}development${RESET} mode."
}